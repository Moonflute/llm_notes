...
export default function Concepts(){
  const concepts=conceptDocuments.map(concept=>{const guide=getConceptStudyGuide(concept.slug);return {...concept,guideMinutes:guide?.estimatedMinutes,objectives:guide?.objectives.length,resources:guide?.resources.length}});
