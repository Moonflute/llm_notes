...
export const conceptClusters:ConceptCluster[]=[
  ...
  {id:"architecture",label:"ARCHITECTURE",titleKo:"모델 구조",description:"Attention, Transformer, 희소 구조와 모델 크기를 결정하는 내부 구성",conceptIds:["attention","attention-variants","mla","positional-encoding","transformer","normalization","ffn-swiglu","mixture-of-experts","dense-vs-sparse","state-space-models","small-language-models"]},
  ...
  {id:"retrieval-agents",label:"RETRIEVAL & AGENTS",titleKo:"검색과 에이전트",description:"외부 지식, 구조화된 도구, 반복 실행과 상태를 결합하는 시스템",conceptIds:["semantic-search","retrieval-augmented-generation","grounding","function-calling","structured-output","mcp","agents","agent-memory"]},
