...
export const conceptClusters:ConceptCluster[]=[
  {id:"foundations",label:"FOUNDATIONS",titleKo:"기초 표현",description:"텍스트가 토큰과 벡터가 되고 모델 입력으로 구성되는 출발점",conceptIds:["tokenization","embedding","context-window","prompt-design"]},
  {id:"architecture",label:"ARCHITECTURE",titleKo:"모델 구조",description:"Attention, Transformer, 희소 구조와 모델 크기를 결정하는 내부 구성",conceptIds:["attention","transformer","mixture-of-experts","dense-vs-sparse","small-language-models"]},
