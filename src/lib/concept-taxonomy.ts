...
export const conceptClusters:ConceptCluster[]=[
  ...
  {id:"architecture",label:"ARCHITECTURE",titleKo:"모델 구조",description:"Attention, Transformer, 희소 구조와 모델 크기를 결정하는 내부 구성",conceptIds:["attention","attention-variants","positional-encoding","transformer","normalization","ffn-swiglu","mixture-of-experts","dense-vs-sparse","state-space-models","small-language-models"]},
